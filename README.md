  ...
  return (
    <div className="relative mt-20">
      ...
      <div className="container mx-auto px-4 relative z-20">
        <div className="bg-gradient-to-r from-blue-900 to-indigo-900 rounded-3xl p-8 md:p-10 shadow-2xl overflow-hidden relative -mb-20">
          ...
          <div className="absolute bottom-0 left-0 w-1/2 h-full bg-gradient-to-t from-purple-500/20 to-transparent pointer-events-none" />
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <Link
              to="/suppliers"
              className="bg-white text-blue-900 px-8 py-3 rounded-full font-bold text-base hover:bg-blue-50 transition-colors shadow-lg flex items-center gap-2 whitespace-nowrap"
            >
